...
from env.uart.uart_simple_env_config import uart_simple_env_config

class uart_simple_env(uvm_env):
    def build_phase(self):
        ...
        self.cfg = cast(uart_simple_env_config, ConfigDB().get(self, "", "cfg"))
