...
class UartAgent(uvm_agent):
    def __init__(self, name="UartAgent", parent=None):
        ...
        self.drv: UartDriver = None
        self.mon: UartMonitor = None
        self.seqr: UartSequencer = None
    ...
    def build_phase(self):
        ...
        self.drv = UartDriver.create("drv", self)
        
        self.mon = UartMonitor.create("mon", self)
        
        self.seqr = UartSequencer.create("seqr", self)
