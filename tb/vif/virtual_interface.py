...
class VirtualInterface:
    ...
    def wire_to_dut(self, dut: SimHandleBase):
    ...
    def init_signal_values(self):
        ...
        self.reset.value = 0
        self.gpio_i.value = 0
        self.exit_pad_io.value = 0
        self.gpio_i.value = 0
        self.gpio_o.value = 0
        self.gpio_oe.value = 0
        self.top_gpio_o.value = 0
        self.top_gpio_oe.value = 0
        self.uart_tx.value = 0
        self.uart_rx.value = 0
        self.uart_rx_en.value = 0
        self.sda_i.value = 0
        self.sda_o.value = 0
        self.sda_oe.value = 0
        self.scl_i.value = 0
