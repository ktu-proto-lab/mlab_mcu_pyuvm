...
\end{figure}
 ...
 \begin{itemize}
 	...
 	\item RTL \texttt{rtl} paketas, kuriame yra aprašytas testuojamojo mikrovaldiklio modulis, jis susideda iš jau aprašytų modulių \texttt{mlab\_mcu} šakninio projekto \texttt{rtl} paketo.
